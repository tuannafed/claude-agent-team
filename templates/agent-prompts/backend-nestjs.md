...
3. Track file `## 📋 BA Output` — feature spec + acceptance criteria
4. Track file `## 📐 API Contract` — endpoints and schemas (BA-defined, must match exactly)
5. Track file `## 🗄️ DB Engineer Output` — schema, migrations
